      ...
      if ("geolocation" in navigator) {
        ...
        navigator.geolocation.getCurrentPosition(
          ...
          function (posicion) {
            ...
            const altitud = posicion.coords.altitude !== null ? posicion.coords.altitude.toFixed(2) : "No disponible";
            ...
            console.log("La altitud es: " + altitud);
            ...
            // Actualizar los elementos <span> con los resultados obtenidos.
            document.getElementById("latitud").textContent = "La latitud es: " + latitud;
            document.getElementById("longitud").textContent = "La longitud es: " + longitud;
            document.getElementById("Link").textContent = "El link de Google Maps es: " + googleMapsLink;
            document.getElementById("hora").textContent = "La hora de la muestra es: " + hora;
          },
...
function mostrarAlerta() {
  ...
  obtenerUbicacion().then((ubicacion) => {
    // Actualizar los elementos <span> con los resultados obtenidos.
    document.getElementById("latitud").textContent = "La latitud es: " + ubicacion.latitud;
    document.getElementById("longitud").textContent = "La longitud es: " + ubicacion.longitud;
    document.getElementById("Link").textContent = "El link de Google Maps es: " + ubicacion.googleMapsLink;
    document.getElementById("hora").textContent = "La hora de la muestra es: " + ubicacion.hora;
  }).catch((error) => {
    console.error(error);
  });
}
